...
class MyNode(Node):
    ...
    def send_vel(self, pose:Pose):
        msg=Twist()
        msg.linear.x=1.5
        if pose.x>=10.0 and pose.theta<=3.1428:
            self.turn_turtle(1.570796)  
            
            return
          
        elif pose.x>=10.0 and pose.theta>=3.1428:
            self.turn_turtle(4.71238898) 
            return 
            
        elif pose.y>=10.0 and pose.theta<=3.1428:
            self.turn_turtle(1.570796)
            return
        elif pose.y<=10.0 and pose.theta>=3.1428:
            self.turn_turtle(4.71238898)
            return
        elif pose.x<=0.5 and pose.theta>=3.1428:
            self.turn_turtle(1.570796)
            return 
        elif pose.x<=0.5 and pose.theta<=3.1428:
            self.turn_turtle(4.71238898) 
        ...
        elif pose.y<=2.0 and pose.theta<=3.1428:
            self.turn_turtle(4.71238898)
            return
        elif pose.y<=2.0 and pose.theta>=3.1428:
            self.turn_turtle(1.570796)
